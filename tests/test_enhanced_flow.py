...
def main():
    ...
    user_data['merchant_data']['category'] = selected_category['id']
    ...
    merchant_created = registration_data.get('merchant_account_created', False)
    ...
    print(f"   - Merchant Created: {'✅' if merchant_created else '❌'}")
